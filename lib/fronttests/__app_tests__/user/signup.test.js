...
export async function test(){
  ...
  //   Dom.hasText("le mot de passe n’est pas correctement confirmé")
    ...
    await Mail.getLastMails(3)

    Mail.sent({after: startTime, to:email, subject: 'Confirmation de votre adresse mail'})
    Mail.sent({after: startTime, to:email, subject: 'Votre candidature a bien été reçue'})
    Mail.sent({after: startTime, to:'phil@atelier-icare.net', subject: 'Nouvelle candidature'})
