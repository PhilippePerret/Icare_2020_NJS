...
export async function test(){
  ...
  //   Dom.hasText("le mot de passe n’est pas correctement confirmé")
    ...
    console.log("Module d'apprentissage choisi : ", modid)
    form.fillWith({
        mail_confirmation: email
    ...
    Mail.sent({after: startTime, to:email, subject: 'Confirmation de votre adresse mèl'}, {success:`Le ${MAIL} de demande de confirmation de mail a été envoyé`})
