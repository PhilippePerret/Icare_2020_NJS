...
/**
  Fonction principale de lancement du test désigné par son chemin relatif
  Ou d'un ensemble de tests
**/
function RunFrontTestsFile(){
  ...
  FrontTests.reset()
  FrontTests.init()
  // console.log("J'import(e) le module : ", `./__app_tests__/${relpath}`)
