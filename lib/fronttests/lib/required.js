...
import('./FrontTests.js')
  .then((mod)=>{
    ...
    **/
    ...
    /**
      |
      | À titre expérimental, on essaie de charger le module
      | bundle.js produit par browserify
      |
    **/
    // try {
    //   import("./bundle.js").then((mod)=>{
    //     console.log("window.readStream1 = ", window.readStream1)
    //     console.log("window.readStream2 = ", window.readStream2)
    //   })
    //   // .catch((err)=>{console.error(err)})
    // } catch (e) {
    //   console.error("erreur contrôlée")
    // } finally {
    //
    // }
  })
